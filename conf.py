...
# {read_more}                   The string â€œRead moreâ€?in the current language.
# {reading_time}                An estimate of how long it will take to read the post.
# {remaining_reading_time}      An estimate of how long it will take to read the post, sans the teaser.
# {min_remaining_read}          The string â€œ{remaining_reading_time} min remaining to readâ€?in the current language.
...
INDEX_READ_MORE_LINK = '<p class="more"><a href="{link}">{read_more}â€?/a></p>'
# 'Read more...' for the RSS_FEED, if RSS_TEASERS is True (translatable)
RSS_READ_MORE_LINK = '<p><a href="{link}">{read_more}â€?/a> ({min_remaining_read})</p>'
...
NAVIGATION_LINKS = {
        DEFAULT_LANG: (
            ...
            ('https://www.linkedin.com/in/shuo-zhang-7a537224/', 'My LinkedIn', 'icon-linkedin'),
